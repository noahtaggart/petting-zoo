from models import Llama, Goat, Sheep, Alpaca, Miniature_Horse, Turtle, Salmon, Catfish, Longnose_Gar, Koi, Milksnake, Scarletsnake, Rough_Greensnake, Cottonmouth, Plain_Bellied_Watersnake, Burro
